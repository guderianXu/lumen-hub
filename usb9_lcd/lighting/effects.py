...
LIGHTING_EFFECTS: tuple[LightingEffect, ...] = (
    ...
    LightingEffect("star", "星空", ("star", "starry night", "sparkle", "twinkle"), True),
    LightingEffect("meteor", "流星", ("meteor", "meteor shower", "comet"), True),
    LightingEffect("comet", "彗星", ("comet", "comet tail", "meteor"), True),
    LightingEffect("scan", "扫描", ("scan", "scanner", "larson scanner"), True),
    LightingEffect("visor", "遮罩", ("visor", "rainbow visor"), True),
    LightingEffect("matrix", "矩阵", ("matrix", "digital rain"), True),
    LightingEffect("gradient", "渐变", ("gradient", "gradient cycle", "gradient wave"), True),
